...
//   //         'Authorization': 'Basic ${base64Encode(utf8.encode('1d28a3b5933bdc8:f0903b5071e0405'))}', 
//   //       },
//   //       body: jsonEncode({
//   //         'date': document['date'],
...
//         });
//         if (kDebugMode) {
//           print('Document created successfully: ${responseData['docname']}');
//         }
//       } else {
//         setState(() {
//           document['status'] = 'Failed';
...
//             context,
//             MaterialPageRoute(builder: (context) => FuelUsedPage()),
//           );
//           if (newDocument != null) {
